...
/**
 * ClassName:WeChatOAuth2Template  <br/>
 * Function: 完成微信的OAuth2认证流程的模板类。国内厂商实现的OAuth2每个都不同, spring默认提供的OAuth2Template适应不了，只能针对每个厂商自己微调。 <br/>
 *
 * @author WangZunBin <br/>
 * @version 0.4 2020/3/30 21:59   <br/>
 */
public class WeChatOAuth2Template extends OAuth2Template {
    ...
    private static final String REFRESH_TOKEN_URL = "https://api.WeChat.qq.com/sns/oauth2/refresh_token";
