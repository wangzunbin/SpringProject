/*
 ...
 Source Server         : home_wzb
 Source Server Type    : PostgreSQL
 Source Server Version : 90522
 Source Host           : 192.168.0.10:5432
 Source Catalog        : postgres
 Source Schema         : public

 Target Server Type    : PostgreSQL
 Target Server Version : 90522
 File Encoding         : 65001

 Date: 27/06/2020 20:01:55
*/


-- ----------------------------
-- Sequence structure for signal_device_job_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."signal_device_job_id_seq";
CREATE SEQUENCE "public"."signal_device_job_id_seq"
INCREMENT 1
MINVALUE  1
...
-- ----------------------------
INSERT INTO "public"."qrtz_locks" VALUES ('scheduler', 'TRIGGER_ACCESS');
...
-- ----------------------------
-- Table structure for signal_device_job
-- ----------------------------
DROP TABLE IF EXISTS "public"."signal_device_job";
CREATE TABLE "public"."signal_device_job" (
  "id" int8 NOT NULL DEFAULT nextval('signal_device_job_id_seq'::regclass),
  "user_id" int8 NOT NULL,
  "device_id" int8 NOT NULL,
  "hour" int2 NOT NULL,
  "minute" int2 NOT NULL,
  "repeat" varchar(13) COLLATE "pg_catalog"."default" NOT NULL,
...
;
COMMENT ON COLUMN "public"."signal_device_job"."id" IS '主键';
COMMENT ON COLUMN "public"."signal_device_job"."user_id" IS '用户ID';
COMMENT ON COLUMN "public"."signal_device_job"."device_id" IS '设备id';
COMMENT ON COLUMN "public"."signal_device_job"."hour" IS '小时';
COMMENT ON COLUMN "public"."signal_device_job"."minute" IS '分钟';
COMMENT ON COLUMN "public"."signal_device_job"."repeat" IS '任务重复策略（“”=只运行一次，1-7表示周一到周日，多个用,分割）';
COMMENT ON COLUMN "public"."signal_device_job"."cron" IS 'cron时间表达式';
COMMENT ON COLUMN "public"."signal_device_job"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."signal_device_job"."update_time" IS '更新时间';
COMMENT ON COLUMN "public"."signal_device_job"."op" IS '操作类型(1=开机 ,0=关机)';
COMMENT ON COLUMN "public"."signal_device_job"."enable" IS '是否启用 (1= 开启, 0 = 禁用 )';
COMMENT ON TABLE "public"."signal_device_job" IS '设备定时任务信息表';

-- ----------------------------
-- Records of signal_device_job
-- ----------------------------
INSERT INTO "public"."signal_device_job" VALUES (6, 3, 2, 1, 30, '1,3,5', '1', '2020-06-14 21:15:36', '2020-06-14 21:15:36', 1, 0);
INSERT INTO "public"."signal_device_job" VALUES (7, 3, 2, 1, 30, '1,3,5', '1', '2020-06-14 21:16:15', '2020-06-14 21:16:15', 1, 0);
INSERT INTO "public"."signal_device_job" VALUES (8, 1, 1, 22, 33, '0', '49 33 22 14 06 ? 2020', '2020-06-14 22:32:50', '2020-06-14 22:32:50', 1, 1);
INSERT INTO "public"."signal_device_job" VALUES (9, 1, 1, 22, 40, '0', '0 40 22 14 6 ? 2020', '2020-06-14 22:38:30', '2020-06-14 22:38:30', 1, 1);
INSERT INTO "public"."signal_device_job" VALUES (10, 1, 1, 22, 45, '0', '0 45 22 14 6 ? 2020', '2020-06-14 22:45:24', '2020-06-14 22:45:24', 1, 1);
INSERT INTO "public"."signal_device_job" VALUES (11, 1, 1, 22, 47, '0', '0 47 22 14 6 ? 2020', '2020-06-14 22:46:02', '2020-06-14 22:46:02', 1, 1);
INSERT INTO "public"."signal_device_job" VALUES (13, 1, 1, 23, 24, '0', '0 24 23 14 6 ? 2020', '2020-06-14 23:21:07', '2020-06-14 23:21:28', 1, 1);
INSERT INTO "public"."signal_device_job" VALUES (14, 1, 1, 23, 29, '0', '0 29 23 14 6 ? 2020', '2020-06-14 23:28:05', '2020-06-14 23:30:21', 1, 1);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."signal_device_job_id_seq"', 15, true);
...
-- ----------------------------
-- Primary Key structure for table signal_device_job
-- ----------------------------
ALTER TABLE "public"."signal_device_job" ADD CONSTRAINT "air_device_job_pkey" PRIMARY KEY ("id");
