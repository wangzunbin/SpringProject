...
public class MethodReference {
    ...
    public static void main(String[] args) {
        ...
        List<Apple> list = Arrays.asList(new Apple("abc", 123L), new Apple("Green", 110L), new Apple("red", 123L));
        ...
        List<Apple> list2 = Arrays.asList(new Apple("abc", 123L), new Apple("Green", 110L), new Apple("red", 123L));
